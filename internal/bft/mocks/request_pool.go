...
// CopyRequests provides a mock function with given fields:
func (_m *RequestPool) CopyRequests() ([][]byte, []types.RequestInfo) {
	ret := _m.Called()

	var r0 [][]byte
	var r1 []types.RequestInfo
	...
	if rf, ok := ret.Get(1).(func() []types.RequestInfo); ok {
		r1 = rf()
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).([]types.RequestInfo)
		}
	}
